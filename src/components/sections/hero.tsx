...
export function HeroSection() {
  return (
    ...
    >
      ...
      <div className="w-full max-w-[600px] mx-auto flex flex-col items-center text-center" style={{ paddingTop: "40vh", paddingBottom: "10vh" }}>
        {/* Avatar */}
        ...
        <div className="animate-in stagger-4 mb-6">
          <p className="text-left" style={{ fontSize: "16px", lineHeight: 1.8, letterSpacing: "0.01em", color: "#999" }}>
